...
namespace SimpppleChild\Blocks\React;

/**
 * Registers React blocks using metadata from `block.json` files.
 *
...
function register_react_blocks(): void {
    ...
    $dirpath = get_stylesheet_directory() . '/blocks/react/build/';
...
add_action('init', __NAMESPACE__ . '\register_react_blocks', 9);
